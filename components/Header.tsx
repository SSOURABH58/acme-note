...
function Header({ className }: HeaderProps) {
  return (
    <div className={`flex justify-between p-6 ${className}`}>
      ...
      <a
        href="#3"
        className="transition-all active:duration-75  px-5 py-1 bg-white/50 rounded-3xl flex justify-center items-center group hover:bg-white hover:scale-105 cursor-pointer border hover:border-sky-400 active:scale-100 active:opacity-70"
      >
